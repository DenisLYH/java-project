 ...
 * @author Denis
 */
public class ViewAndUpdateOrderV extends javax.swing.JFrame {
     ...
     */
    public ViewAndUpdateOrderV(String UserID) {
        initComponents();
        VendorID = UserID;
        showTB(VendorID);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewAndUpdateOrderV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new ViewAndUpdateOrderV().setVisible(true);
            }
        });
    }
