...
public class Notifications extends javax.swing.JFrame {
    ...
    public Notifications(String UserID) {
        initComponents();
        loadnotifications(jTable1, UserID);
    }
    
     public static void loadnotifications(JTable jTable1,String UserID){
       String notificationFilePath = "notifications.txt";
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(notificationFilePath))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (notification.userID.equals(UserID)) { // Filter by logged-in user
        ...
        for (Notification notification : notifications) {
            model.addRow(new Object[]{notification.notificationContent, notification.getDate()});
    }
     }
    /**
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new Notifications(testUserID).setVisible(true);
            }
        });
    }
